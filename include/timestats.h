 ...
 * TIME OPERATIONS
 */
EXTERNC ERROR_CODE time_init_slot(const unsigned int slot, const clock_t initial_time, p_timestats stats);
EXTERNC ERROR_CODE time_set_slot(const unsigned int slot, const clock_t end_time, p_timestats stats);
